...
class Animal {
 public:
  ...
  // generic talk method
  virtual void talk() const { cout << "Animal noise\n"; }
...
class Dog : public Animal {
 public:
  ...
  // C++ already knows this is virtual, and it's good practice to
  // include the override
  void talk() const override { cout << "Go Dogs Go!\n"; }
...
class Cat : public Animal {
 public:
  ...
  void talk() const override { cout << "meow\n"; }

  // *new* getters and setters
  string getFavoriteFood() const { return favoriteFood; }
  void setFavoriteFood(const string& newFavoriteFood) {
...
int main() {
  ...
  Cat lonzo("Alonzo", 0, "tuna");
  lonzo.talk();

  cout << endl;

  // I can make a vector of Animal pointers, and put derived classes inside!
  // This is fine because every Cat/Dog *is an* Animal!
  // I can treat a Cat/Dog like animal, and just call the Animal parts
